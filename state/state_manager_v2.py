"""
State Manager V2 - SQLite-backed implementation.

Provides the same interface as the original StateManager but uses SQLite
via SQLAlchemy instead of JSON files.

This module maintains backward compatibility with existing code while
providing the benefits of a proper database.
"""
...
# ============================================================================
# State Manager V2 - SQLite-backed
# ============================================================================
...
class StateManagerV2:
    ...
    Provides the same interface as the original StateManager for
    ...
    def save(self, state: TrackerState) -> None:
        ...
        Note: This is generally not needed as individual update methods
        handle persistence. Provided for compatibility.
        """
        # Individual operations handle their own commits
        pass
...
# ============================================================================
# Credentials Manager V2 - SQLite-backed
# ============================================================================


class CredentialsManagerV2:
    """
    Manages Monarch Money credentials with encryption at rest.

    Same interface as original CredentialsManager but uses SQLite.
    """
...
# ============================================================================
# Notes State Manager V2 - SQLite-backed with encryption
# ============================================================================


class NotesStateManagerV2:
    """
...
CredentialsManager = CredentialsManagerV2
NotesStateManager = NotesStateManagerV2
