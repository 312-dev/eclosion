...
export const DOC_MAPPINGS: DocMapping[] = [
  ...
  // Refunds feature
  {
    topic: 'refunds-overview',
    sourceFiles: [
      'frontend/src/components/refunds/RefundsTab.tsx',
      'frontend/src/components/refunds/TransactionRow.tsx',
      'frontend/src/components/refunds/TallyBar.tsx',
      'frontend/src/components/refunds/ViewTabs.tsx',
      'frontend/src/components/refunds/RefundMatchModal.tsx',
      'frontend/src/components/refunds/ViewConfigModal.tsx',
    ],
    outputFile: 'docusaurus/docs/refunds/overview.mdx',
    feature: 'refunds',
    userFlow: 'main-dashboard',
    sidebarPosition: 1,
  },
