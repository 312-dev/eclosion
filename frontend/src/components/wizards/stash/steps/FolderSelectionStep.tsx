/**
 * FolderSelectionStep - Bookmark folder selection for stash wizard
 */
  ...
  return (
    <div className="animate-fade-in">
      ...
      <p className="mb-4" style={{ color: 'var(--monarch-text-muted)' }}>
        Select a bookmark folder to sync with your stash. New bookmarks in this folder will
        automatically create stashes.
      </p>
