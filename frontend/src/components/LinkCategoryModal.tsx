    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      >
        ...
        <div className="flex-1 overflow-y-auto p-4">
            ...
            <div className="space-y-4">
              {filteredGroups.map((group) => (
                <div key={group.groupId}>
                  <div className="text-xs font-medium uppercase tracking-wide mb-2" style={{ color: 'var(--monarch-text-muted)' }}>
                    {group.groupName}
                  </div>
          ...
          {/* Sync Name Option */}
          {selectedCategory && (
            <div className="mt-6 p-4 rounded-lg" style={{ backgroundColor: 'var(--monarch-bg-page)' }}>
              <div className="text-sm font-medium mb-3" style={{ color: 'var(--monarch-text-dark)' }}>
              ...
              <div className="space-y-3">
                <label
                  ...
                  style={{
                    backgroundColor: syncName ? 'rgba(255, 105, 45, 0.08)' : 'transparent',
                    border: syncName ? '1px solid var(--monarch-orange)' : '1px solid transparent',
                  }}
                >
                  <input
                    type="radio"
                    ...
                    style={{ accentColor: 'var(--monarch-orange)', outline: 'none', boxShadow: 'none' }}
                  />
                  <div className="flex-1">
                    ...
                    <div className="text-xs mt-1" style={{ color: 'var(--monarch-text-muted)' }}>
                      ...
                      <strong style={{ color: 'var(--monarch-orange)' }}>{item.category_name || item.name}</strong>
                    </div>
                  </div>
                </label>
                <label
        ...
        <div className="p-4 border-t flex gap-3" style={{ borderColor: 'var(--monarch-border)' }}>
          ...
          <button
            ...
            className="flex-1 px-4 py-2 text-sm text-white rounded-lg transition-colors disabled:opacity-50 disabled:cursor-not-allowed btn-hover-lift"
            style={{
              backgroundColor: !selectedCategory || saving ? 'var(--monarch-orange-disabled)' : 'var(--monarch-orange)',
            }}
          >
