        ...
        <header className="app-header">
          <div className="app-header-content relative">
            <div className="app-brand">
              ...
              <span className="app-slogan hidden lg:block" style={{ color: 'var(--monarch-text-muted)', fontSize: '14px', fontStyle: 'italic', marginLeft: '12px', paddingLeft: '12px', borderLeft: '1px solid var(--monarch-border)' }}>
            ...
            <div className="app-header-actions">
              ...
              >
                <ShieldCheck className="app-header-icon" />
              </button>
              <button
                onClick={handleHelpClick}
                className="app-header-btn hidden sm:flex"
                style={{ color: 'var(--monarch-text-muted)' }}
                title={hasTour ? 'Show tutorial' : 'Get help'}
              >
                <HelpCircle className="app-header-icon" />
              </button>
            </div>
          </div>
        </header>
