...
function NavItemLink({ item, onSettingsClick }: Readonly<{ item: NavItem; onSettingsClick?: (hash: string) => void }>) {
  return (
    ...
    >
      ...
      {item.settingsHash && onSettingsClick && (
        <button
          type="button"
          onClick={(e) => {
            e.preventDefault();
            e.stopPropagation();
            onSettingsClick(item.settingsHash!);
          }}
...
export function SidebarNavigation({ onSignOut }: Readonly<SidebarNavigationProps>) {
  ...
  return (
    <nav className="sidebar-nav">
        ...
        <div className="sidebar-nav-sections">
          <div className="sidebar-nav-section">
            <div className="sidebar-nav-header-row">
              <div className="sidebar-nav-header">TOOLKIT</div>
              <div className="sidebar-suggest-dropdown" ref={ideaMenuRef}>
                ...
                {ideaMenuOpen && (
                  <div className="sidebar-idea-menu">
                    <a
            ...
            <div className="sidebar-nav-list">
              {toolkitItems.map((item) => (
                <NavItemLink key={item.path} item={item} onSettingsClick={handleSettingsClick} />
              ))}
            </div>
          </div>
      ...
      <div className="sidebar-nav-mobile-separator" />
      ...
      <div className="sidebar-nav-footer sidebar-desktop-only">
        <div className="sidebar-nav-list">
          <button onClick={onSignOut} className="sidebar-nav-item sidebar-signout">
