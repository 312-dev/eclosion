...
export interface DemoState {
  ...
  refundsConfig: import('../types/refunds').RefundsConfig;
  refundsViews: import('../types/refunds').RefundsSavedView[];
  refundsMatches: import('../types/refunds').RefundsMatch[];
  refundsTransactionTagOverrides: Record<string, string[]>;
}
...
export function createInitialDemoState(): DemoState {
  return {
    ...
    refundsMatches: [],
    refundsTransactionTagOverrides: {},
  };
}
